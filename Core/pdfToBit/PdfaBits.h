...
public:
    ...
    static void writeBlock(const std::string& nodePath, const std::string& filename, int index, const std::vector<uint8_t>& data);
    static std::vector<uint8_t> readBlock(const std::string& nodePath, const std::string& filename, int index);
    ...
    static void rebuildMissingBlock(int stripeIndex, const std::vector<std::string>& nodePaths, int missingNodeIndex, const std::string& filename);
};